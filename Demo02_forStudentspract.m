        ...
        %------------------------------------------
         if FFF(2),                             % paused?
           while (FFF(2)),                      % loop here, while paused.
             ...
             if (FFF(6))==1,  ChooseROIandEstimatePlane(Depth,ROI); FFF(6)=0; 
             end;
           end;        
        end;
      ...
      % in rad/second, 3D gyroscopes. 
        ...
        %....................... Depth data
            ...
            % hp: handle to plot3 GO. 
             ...
             if (FFF(6)),
                if (FFF(6))==1,   ChooseROIandEstimatePlane(Depth,ROI);  FFF(2)=1;    end;
...
% exists.
 ...
 function ChooseROIandEstimatePlane(Depth,ROI)
  if isempty(ROI) 
